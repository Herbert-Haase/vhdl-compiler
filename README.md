...
Ich habe einen Listener-/Walker-Pattern verwendet. Enter ist pre-Order-traversal (von links nach rechts) und exit ist post-order-traversal (von rechts nach links). zum Zusammenbauen habe ich die Pop-Attach und Build-Attach Methodik verwendet. Für die Expression habe ich wegen des Rekursiven Aufrufens einen eigen Stack verwenden.
```
